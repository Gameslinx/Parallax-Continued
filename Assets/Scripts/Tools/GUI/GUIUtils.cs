...
//
// Parallax GUI helper functions. None of this is my own code. Mostly adapted from https://forum.unity.com/threads/float-input-gui-item.83739/
//
/// <summary>
...
public static class GUIUtils
{
    ...
    public static Vector3 Vector3Field(Vector3 value)
    {
        ...
        Rect pos = GUILayoutUtility.GetRect(new GUIContent(value.ToString()), GUI.skin.label, new GUILayoutOption[] { GUILayout.ExpandWidth(true), GUILayout.MinWidth(40) });
